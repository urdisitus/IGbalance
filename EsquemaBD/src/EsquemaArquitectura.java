...
public class EsquemaArquitectura {
	/**
	 * @param args
	 */
	public static void main(String[] args) throws Exception {
		Schema esquema = new Schema(1,
				"com.ernesto.perez.balancepersonal.datos.entidades");
		...
		Entity imagen = esquema.addEntity("ImagenD");
		...
		Entity banco = esquema.addEntity("BancoD");
		banco.addIdProperty().autoincrement();
		banco.addStringProperty("nombre").notNull();
		banco.addIntProperty("tipo").notNull();
		banco.addLongProperty("resImagen").notNull();

		Entity origenFinanciero = esquema.addEntity("OrigenFinancieroD");
		...
		origenFinanciero.addLongProperty("resImagen").notNull();

		Entity cuenta = esquema.addEntity("CuentaD");
		...
		Entity categoria = esquema.addEntity("CategoriaD");
		categoria.addIdProperty().autoincrement();
		categoria.addStringProperty("nombre").notNull();
		categoria.addLongProperty("resImagen").notNull();

		Entity adjunto = esquema.addEntity("AdjuntoD");
		...
		Entity anulacionMovimiento = esquema.addEntity("AnulacionMovD");
		...
		Entity movimiento = esquema.addEntity("MovimientoD");
		...
		movimiento.addIntProperty("tipoMovimiento").notNull();
		...
		// Entity movimientoPeriodico =
		// esquema.addEntity("MovimientoPeriodico");
		...
		// movimientoPeriodico.addToOne(origenFinanciero,
		// origenFinToMovimientoP,
		// "origenFinanciero");
		// origenFinanciero.addToMany(movimientoPeriodico,
		// origenFinToMovimientoP,
		// "movimientosPeriodicos");
		...
		// "movimientoPeriodico");
		// detallePeriodico.addToOne(movimiento, movToDetalleMovP,
		// "movimiento");
		...
		// contacto.addToOne(imagen,
		// contacto.addLongProperty("idFoto").notNull()
		// .getProperty(), "foto");
		//
