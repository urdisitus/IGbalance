...
public class Esquema {
	...
	public static void main(String[] args) throws Exception {
		...
		movimiento.addDateProperty("importe").notNull();
		...
		movimientoPeriodico.addDoubleProperty("monto").notNull();
		...
		contacto.addToOne(imagen,contacto.addLongProperty("idFoto").notNull().getProperty(),"foto");
		...
		Property prestamoToDetallePrestamo = detallePrestamo.addLongProperty("idPrestamo").notNull().getProperty();
		Property movimientoToDetallePrestamo = detallePrestamo.addLongProperty("idMovimiento").notNull().getProperty();
		prestamo.addToMany(detallePrestamo, prestamoToDetallePrestamo,"movimientos");
		movimiento.addToMany(detallePrestamo, movimientoToDetallePrestamo,"prestamos");
		detallePrestamo.addToOne(prestamo, prestamoToDetallePrestamo, "prestamo");
		detallePrestamo.addToOne(movimiento, prestamoToDetallePrestamo,"movimiento");
		...
		Property ajusteToDetalleAjuste = detalleAjuste.addLongProperty("idAjuste").notNull().getProperty();
		Property movimientoToDetalleAjuste = detalleAjuste.addLongProperty("idMovimiento").notNull().getProperty();
		ajuste.addToMany(detalleAjuste, ajusteToDetalleAjuste,"movimientos");
		movimiento.addToMany(detalleAjuste, movimientoToDetalleAjuste,"ajustes");
...
//		contactoToMensaje.setName("mensajes");
		...
		new DaoGenerator().generateAll(esquema,
				"F:/Documentos/proyectos externos/BalancePersonal/workspace/BalancePersonal/src-gen");
	}
